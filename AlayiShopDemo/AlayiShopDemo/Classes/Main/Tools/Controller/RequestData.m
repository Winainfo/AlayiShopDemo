...
+(void)lgin:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    //去除空格和\n
    NSString *resString =
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    //const char *cStr = [resString UTF8String];
    NSDictionary *params=@{@"method":@"login",@"appid":APPID,@"data":resString,@"sign":sign};
...
+(void)registers:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSString *))block
{
    ...
    NSDictionary *params=@{@"method":@"register",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
+(void)getFoodSortList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getFoodSortList",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
         NSLog(@"分类请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getFoodListWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    //去除空格和\n
    NSString *resString =
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getFoodListWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
+(void)getFoodById:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getFoodById",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getUserCartList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserCartList",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getUserCartListCount:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserCartListCount",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)doAddCart:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"doAddCart",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)doDeleteCart:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"doDeleteCart",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)delUserAllCart:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"delUserAllCart",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)updateCartNumber:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"updateCartNumber",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"更新购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getShopList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getShopList",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"更新购物车数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)doCartToOrder:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"doCartToOrder",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"提交数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getUserOrderListWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserOrderListWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"订单数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getOrderInfoByOrderid:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getOrderInfoByOrderid",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"订单数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getOrderListByOrderid:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getOrderListByOrderid",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"订单数据请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getInfoSortList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getInfoSortList",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"信息数据请求成功--");
        block(responseObject);
...
+(void)getInfoListWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getInfoListWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"信息数据请求成功--");
        block(responseObject);
...
+(void)getInfoById:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getInfoById",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
...
+(void)doAddUserFeedback:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"doAddUserFeedback",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"信息数据请求成功--");
        block(responseObject);
...
+(void)getAllSelfFoodWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getAllSelfFoodWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
+(void)getUserSelfFoodWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserSelfFoodWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"自制菜数据请求成功--");
        block(responseObject);
...
+(void)getSelfFoodById:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getSelfFoodById",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"自制菜数据请求成功--");
        block(responseObject);
...
+(void)getFoodCommentList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getFoodCommentList",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"评论数据请求成功--");
        block(responseObject);
...
+(void)getUsercenterInfo:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUsercenterInfo",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"积分数据请求成功--");
        block(responseObject);
...
+(void)getUserAllScoreWithPage:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserAllScoreWithPage",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"积分数据请求成功--");
        block(responseObject);
...
+(void)chgpass:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"chgpass",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"修改密码请求成功--");
        block(responseObject);
...
+(void)dobjzh:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"dobjzh",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"修改帐号请求成功--");
        block(responseObject);
...
+(void)getAllHotFoodList:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getAllHotFoodList",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"请求成功--");
        block(responseObject);
...
+(void)delSelfFood:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"delSelfFood",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"请求成功--");
        block(responseObject);
...
+(void)saveSelfFood:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"saveSelfFood",@"appid":APPID,@"data":resString,@"sign":sign};
    //3.发生请求
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"请求成功--");
        block(responseObject);
...
+(void)addFoodComment:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"addFoodComment",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)orderCancel:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"orderCancel",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getAllUserSendAddressByUserid:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getAllUserSendAddressByUserid",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getUserSendAddressById:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getUserSendAddressById",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)saveUserSendAddress:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"saveUserSendAddress",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)delUserSendAddress:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"delUserSendAddress",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)updateIsdefault:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"updateIsdefault",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
...
+(void)getAllUserSendAddressByAddressPhoneName:(NSDictionary *)data FinishCallbackBlock:(void (^)(NSDictionary *))block
{
    ...
    [[jsonDic stringByReplacingOccurrencesOfString:@" " withString:@""]
     stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSDictionary *params=@{@"method":@"getAllUserSendAddressByAddressPhoneName",@"appid":APPID,@"data":resString,@"sign":sign};
    [mgr POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"添加请求成功--");
        block(responseObject);
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
